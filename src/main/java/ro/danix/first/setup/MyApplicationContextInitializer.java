...
//        }
    ...
    /**
     * This enables overriding the env-${target}.properties location, which is
     * by default resolved internally from the classpath. The entire purpose of
     * overriding this specific properties file is to be able to control the
     * active Spring profile without defining system wide variables on the OS
     * that runs staging
     */
